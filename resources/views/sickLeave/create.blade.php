...
<head>
    ...
    <title>Выписка больничного</title>
...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('vacations.store', $employee->id) }}" method="POST" class="grid grid-cols-2 gap-4">
        ...
        <div class="m-2">
            <label for="start_date" class="block text-gray-700">Дата заболевания</label>
            <input type="date" name="start_date" id="start_date"
                   class="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-md p-2" required>
        </div>

        <div class="m-2">
            <label for="end_date" class="block text-gray-700">Дата выздоровления</label>
