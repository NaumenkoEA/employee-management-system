...
<head>
    ...
    <title>Редактирование больничного</title>
...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('vacations.update', [$employee->id, $sickLeave->id]) }}" method="POST"
        ...
        <div class="m-2">
            <label for="start_date" class="block text-gray-700">Начало болезни:</label>
        ...
        <div class="m-2">
            <label for="end_date" class="block text-gray-700">Конец болезни:</label>
